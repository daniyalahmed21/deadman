...
cd mcp && DEADMAN_DEMO_MODE=1 npm start          # http://localhost:9000
...
| 2:30 | `node mcp/scripts/generate_postmortem` output / postmortem | "A full postmortem, generated from the audit trail." |
| 2:40 | `node mcp/scripts/cost.mjs <session>` | "The whole incident cost about **nine cents**, 88% served from cache." |
